...
namespace IPCountryBlocker.Application.Validators.Students
{
    public class UpdateStudentValidator : AbstractValidator<UpdateStudentRequest>
    {
        ...
        public UpdateStudentValidator(IStringLocalizer<SharedResources> localizer, IStudentRepository studentRepository)
        {
        ...
        public void ApplyValidationRules()
        {
            RuleFor(x => x.Id)
                ...
                .MustAsync(StudentIdExistsAsync)
        ...
        private async Task<bool> StudentIdExistsAsync(int studentId, CancellationToken cancellationToken)
        {
