namespace IPCountryBlocker.Application.Resources
{
    public static class SharedResourcesKeys
    {
        ...
        public const string IpAllowed = "IpAllowed";
        public const string AlphaFormat = "AlphaFormat";
        public const string DurationMaxLimit = "DurationMaxLimit";
        public const string DurationMinLimit = "DurationMinLimit";
