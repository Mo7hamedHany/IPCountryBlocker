...
{
    public class TemporalBlockCountryValidator : AbstractValidator<TemporalCountryBlockCommand>
    {
        private readonly IStringLocalizer<SharedResources> _localizer;
        private readonly ICountryRepository _countryRepository;

        public TemporalBlockCountryValidator(IStringLocalizer<SharedResources> localizer, ICountryRepository countryRepository)
        {
        ...
        public void ApplyValidationRules()
        {
            ...
            .WithMessage(_localizer[SharedResourcesKeys.DurationMinLimit])
            .LessThanOrEqualTo(1440)
            .WithMessage(_localizer[SharedResourcesKeys.DurationMaxLimit]);
